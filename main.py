...
def main():
    ...
    amortized_capital = calculate_amortization(
        base_amount, interest_rate, opening_fee, paid_until_now)
    ...
    print_summary("RESUMEN DESPUÉS DE LA APORTACIÓN EXTRA",
                  amortized_capital, amount_remaining, end_date_post)
